  ...
  <div>
    <section class="bg-white dark:bg-gray-900">
      <div class="mx-auto max-w-screen-xl px-4 py-8 text-center lg:py-16">
        ...
        >
          We invest in the world’s potential {{ testVar }}
        </h1>
        <p
          class="mb-8 font-lugrasimo text-lg font-normal text-gray-500 dark:text-gray-400 sm:px-16 lg:px-48 lg:text-xl"
        >
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-x-4 sm:space-y-0">
          <a
            href="#"
            class="inline-flex items-center justify-center rounded-lg bg-blue-700 px-5 py-3 text-center font-poppins text-base font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
          >
            Get started
            <svg
...
<script setup>
const testVar = ref('old value')
onMounted(() => {
  testVar.value = 'new value'
